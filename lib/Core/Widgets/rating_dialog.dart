...
import 'package:mobo_rental/Core/const/app_colors.dart' as colors;
import '../services/review_service.dart';

/// A custom dialog for gathering user ratings and feedback.
///
/// Shows a star rating bar and an optional comment field for low ratings.
class CustomRatingDialog extends StatefulWidget {
  /// Callback triggered when a rating of 4 or 5 is submitted.
  final Function(double, String) onGoodReview;

  /// Callback triggered when a rating of 1, 2, or 3 is submitted.
  ...
  /// Displays the [CustomRatingDialog] using the provided [context].
