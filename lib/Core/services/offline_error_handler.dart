...
class OfflineErrorHandler {
  ...
  /// Subscription for server reachability changes.
  StreamSubscription<bool>? _serverSubscription;

  /// Stores the last known BuildContext to display snackbars.
  BuildContext? _lastContext;

  /// Flag to prevent showing the offline snackbar multiple times.
  bool _hasShownOfflineSnackbar = false;

  /// Flag to prevent showing the server unreachable snackbar multiple times.
  ...
  /// Classifies various error types and returns a user-friendly message.
  ///
  /// Maps network, authentication, and Odoo-specific errors to clear 
  /// descriptions for the end-user.
  ...
  /// Checks if the given [error] is related to connectivity or network stability.
