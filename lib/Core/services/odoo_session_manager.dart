...
import 'package:mobo_rental/Core/models/appsession.dart';
import 'package:mobo_rental/Core/services/connectivity_service.dart';
import 'package:mobo_rental/Core/services/secure_storage_service.dart';
...
class OdooSessionManager {
  ...
  static bool get hasSession => _cachedSession != null;
  ...
  @visibleForTesting
  static void injectMockClient(OdooClient client) {
    _client = client;
    _cachedSession = AppSessionData(
