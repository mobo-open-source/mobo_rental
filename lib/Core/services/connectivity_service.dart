...
class ConnectivityService {
  ...
  ///
  /// This sets up listeners for both system connectivity and manual 
  /// internet/server probes.
  ...
  /// Returns true if the app currently has verified internet access.
  bool get isConnected => _lastInternetReachable;
  ...
  /// Checks if the device has a network interface active (WiFi, Mobile, etc).
  ///
