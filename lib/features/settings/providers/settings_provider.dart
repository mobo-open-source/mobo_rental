...
/// Provider for managing application settings, language, currency, and timezone.
class SettingsProvider extends ChangeNotifier {
  ...
  /// Initializes the provider by loading local settings and fetching remote data.
  ...
  /// Loads settings from local SharedPreferences.
  ...
  /// Persists all current settings to SharedPreferences.
  ...
  /// Fetches all language, currency, and timezone data from Odoo.
  ...
  /// Fetches available languages from Odoo.
  ...
  /// Returns the human-readable name for a given language [code].
  ...
  /// Clears the application cache and resets settings if needed.
